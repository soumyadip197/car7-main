...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col ">
      ...
      <div className="relative h-screen flex flex-col justify-center items-center text-center bg-gradient-to-br from-black via-gray-900 to-black">
    {/* Optional animated gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#00fff7]/20 via-transparent to-[#7b2ff7]/20 animate-pulse-slow z-0"></div>

         <div className="z-10 text-white">
           <h1 className="text-5xl md:text-7xl font-extrabold text-[#00fff7] animate-neon-flicker drop-shadow-[0_0_20px_#00fff7]">
              Find Your Dream Car with CAR7
          </h1>
